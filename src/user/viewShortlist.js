...
import ImageHelperShort from '../property/helper/imageHelperShort'
...
class ViewShortlist extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            dist: null
            ...
            return (
                ...
                >
                  <div
                    className="cards"
                  >
                    <ImageHelperShort className="prodimage" product={this.props.location.val.product} len={this.props.location.val.product.allimglen} />
                    <h3>
